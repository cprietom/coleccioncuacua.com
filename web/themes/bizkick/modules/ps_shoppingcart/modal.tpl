        ...
        <div class="row">
          ...
          <div class="col-md-7">
            <div class="cart-content">
              ...
              <p><strong>{l s='Total shipping:' d='Shop.Theme.Checkout'}</strong>&nbsp;{$cart.subtotals.shipping.value} n1: {$numerico} c: {$country_name} s: {$shop_country_name}{hook h='displayCheckoutSubtotalDetails' subtotal=$cart.subtotals.shipping}</p>
