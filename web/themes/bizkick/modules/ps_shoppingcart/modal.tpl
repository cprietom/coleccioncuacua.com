        ...
        <div class="row">
          ...
          <div class="col-md-7">
            <div class="cart-content">
              ...
              <p><strong>{l s='Total shipping:' d='Shop.Theme.Checkout'}</strong>&nbsp;{$cart.subtotals.shipping.value} c: {$country_name} {hook h='displayCheckoutSubtotalDetails' subtotal=$cart.subtotals.shipping}</p>
